...
BLOG_AUTHOR = "Petru Rebeja"  # (translatable)
BLOG_TITLE = "Rebeja"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://rebeja.eu/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://blog.rebeja.eu/"
BLOG_EMAIL = "petru.rebeja@gmail.com"
BLOG_DESCRIPTION = "Single threaded stories."  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by   <a href="https://www.gnu.org/software/emacs/" rel="nofollow">GNU Emacs</a>  &amp;    <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
